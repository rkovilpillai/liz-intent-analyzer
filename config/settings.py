...
CLIENT_SECRETS_FILE = "client_secret.json" if not is_cloud() else None
SCOPES = [
    'openid', 
    'https://www.googleapis.com/auth/userinfo.email', 
    'https://www.googleapis.com/auth/userinfo.profile'
]
REDIRECT_URI = 'http://localhost:8501/' if not is_cloud() else 'https://liz-intent-analyzer-test.streamlit.app/'
...
from config.settings import CLIENT_SECRETS_FILE, SCOPES, REDIRECT_URI, AUTH_STORAGE_FILE, is_cloud
