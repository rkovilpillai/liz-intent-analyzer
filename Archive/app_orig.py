...
GOOGLE_CLIENT_ID = "1030728653402-osfok26hos0thgkn1v1hhdd4nqakp4sb.apps.googleusercontent.com"
GOOGLE_CLIENT_SECRET = "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"

if not user:
    st.title("🔐 Please Sign In with Google")
    flow_url = (
        "https://accounts.google.com/o/oauth2/auth?"
        "client_id=1030728653402-osfok26hos0thgkn1v1hhdd4nqakp4sb.apps.googleusercontent.com&"
        "redirect_uri=http://localhost:8501&"
        "scope=openid%20email%20profile&"
        "response_type=code&"
        "access_type=offline"
    )
    st.markdown(f"[🔓 Sign in with Google]({flow_url})")
    st.stop()
...
# 👉 Place your original app code here
st.title("Your Full App Logic Goes Here")
